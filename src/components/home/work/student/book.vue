<template>
  <div class="dorm">
          ...
          <el-col :span="24" style="border-right: 1px solid #eee;">
            <router-link :to="link.form">
              <div class="m-auto p-3">
                ...
                <span style="font-size: 14px">预约就诊</span>
              </div>
            </router-link>
          </el-col>
        </el-row>
    ...
    <el-card class="box-card rounded-0" shadow="never">
      <div slot="header" style="border-left: 5px solid #E6A23C;padding-left: 12px">待审批预约</div>
    ...
    <div class="p-1"></div>
    <el-card class="box-card rounded-0" shadow="never">
      <div slot="header" style="border-left: 5px solid #409EFF;padding-left: 12px">我的预约</div>
...
<script>
  ...
  export default {
    ...
    activated() {
      this.applyDorm = getCache('applyDorm1')
      this.myDorm = getCache('myDorm1')
    },
    methods: {
      del(index) {
        this.applyDorm.splice(index, 1)
        setCache('applyDorm1', this.applyDorm)
